...
const getPaymentErrorMessage = (err: any) => {
  ...
  if (String(message).toLowerCase() === 'internal_error') {
    return 'Mercado Pago devolvio internal_error. Para aprobar la prueba usa titular APRO y documento 123456789. Si DNI no acepta 9 digitos, elige otro tipo de documento.';
  }
          ...
          {paymentMode === 'mercadopago' && (
            <div className="mb-4 rounded-lg border border-[#eadfd2] bg-[#fffaf6] px-4 py-3 text-sm leading-6 text-[#524535]">
              ...
              <p>
                ...
                <strong>123456789</strong>. Si DNI no acepta 9 digitos, elige otro tipo de documento.
              </p>
            </div>
          )}
